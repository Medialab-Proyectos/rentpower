  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm text-white/60" style={{ fontFamily: "var(--font-inter)", letterSpacing: "-0.01em" }}>
          <a href="#ecosistema" className="hover:text-white transition-colors">
            Ecosistema
          </a>
